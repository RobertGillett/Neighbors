...
extension Notification.Name {
    ...
    public static let VideoDownloadProgressDidChanged = Notification.Name(rawValue: "me.neighbor.player.downloader.progress.changed")
    
    public static let VideoDownloadDidFinished = Notification.Name("me.neighbor.player.downloader.finished")
